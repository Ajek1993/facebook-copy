...
export default function NavigationButton({ font, path }: AppProps) {
  ...
  return (
    <Link href={path}>
      <div
        className={`h-[50px] w-max-[120px] hidden md:flex justify-center items-center sm:px-4 md:px-6 lg:px-10 xl:px12 2xl:px-16 py-2 hover:bg-secondary_darkGrey rounded-xl relative ${
          actualPath === path
